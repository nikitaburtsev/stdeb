...
Vagrant::Config.run do |config|
  ...
  config.vm.provision :shell, :inline => "apt-get install --yes debhelper python-all-dev python-setuptools apt-file libxml2-dev libxslt1-dev zlib1g-dev python-requests python3-all-dev python3-setuptools"
